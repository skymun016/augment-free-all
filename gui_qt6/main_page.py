...
# import webbrowser  # 已移除GitHub链接功能
import psutil
...
# from .about_dialog import AboutDialog  # 已移除关于对话框
...
class MainPage(QWidget):
    ...
    def _create_bottom_section(self, parent_layout):
        """创建底部信息区域 - 已简化，移除版本和版权信息"""
        # 底部信息已移除，保持方法存在以避免调用错误
        pass
    ...
    # _show_about 和 _open_github 方法已移除
